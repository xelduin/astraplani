...
1. **Report a Bug**
    ...
    - If you think you have encountered a bug, and we should know about it, feel free to report it [here](https://github.com/dojoengine/contracts/issues) and we will take care of it.

2. **Request a Feature**

    - You can also request for a feature [here](https://github.com/dojoengine/contracts/issues), and if it's viable, it will be picked for development.
